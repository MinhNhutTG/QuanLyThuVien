...
namespace QUANLYTHUVIEN.GUI
{
    public partial class GUI_QuanLyThuThu : Form
    {
        ...
        {
            GUI_ThemSuaThuThu frmThem = new GUI_ThemSuaThuThu(null, true);
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                GUI_ThemSuaThuThu frmSua = new GUI_ThemSuaThuThu(false, listView1.SelectedItems[0].SubItems[0].Text);
