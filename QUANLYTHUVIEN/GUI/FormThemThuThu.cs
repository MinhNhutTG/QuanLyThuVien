...
using static QUANLYTHUVIEN.BUS.BUS_ThuThu;
...
namespace QUANLYTHUVIEN.GUI
{
    public partial class FormThemThuThu : Form
    {
        ...
        public FormThemThuThu(string MaThuThu, bool enable) //constructer tạo form thêm thủ thư với 1 tham số enable để ẩn nút cập nhật
        {
            InitializeComponent();
            setButton(enable);
            HienThiNamNu();
         ...
         // sua 
        public FormThemThuThu(bool enable, string MaThuThu)
        {
            InitializeComponent();
            setButton(enable);
            HienThiNamNu();
        ...
        {           
            ...
            catch (BusinessLogicExcepttion ex)
            {
