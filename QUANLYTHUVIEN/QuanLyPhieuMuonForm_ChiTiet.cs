...
{
    public partial class QuanLyPhieuMuonForm_ChiTiet : Form
    {
        XuLyFormMuonTra x = new XuLyFormMuonTra();
        public QuanLyPhieuMuonForm_ChiTiet(string key)
        {

            InitializeComponent();
            DataTable dtPM = x.LayThongTinPhieu(key);
            DataTable dtS = x.LayDanhSachSachTheoMaPhieu(key);
